...
function Post() {
    return (
        <div className='w-full text-white border-b-2 border-zinc-900 rounded-lg m-2 p-2 flex justify-center items-start flex-col'>
            ...
            <img className='w-90  border-2 border-zinc-900 rounded-lg hover:shadow-md hover:shadow-zinc-700/40' src='https://i.pinimg.com/736x/2a/86/6b/2a866b05017d497cc3a56abebf63d5d7.jpg' alt="Post" />
            {/* )} */}
