...
function UpdateProfile() {
    ...
    const handleAvtarChange = async (event) => {
        ...
        try {
            const response = await postService.updateAvtarService(file)
            if (response.success) {
    ...
    const handleUpdate = async (data) => {
        ...
        setLoading(true);
        try {
            const userProfile = await postService.updateService(data);
            if (userProfile) {
                navigate('/profile');
            }
        } catch (error) {
    ...
    return (
        <div className='bg-zinc-950 text-white p-4 w-full min-h-screen flex justify-center items-center'>
            <Container>
                <form onSubmit={handleSubmit(handleUpdate)} className='border-2 border-zinc-700 rounded-lg py-3 px-2'>
                        ...
                        <div className='flex flex-col items-center py-3 px-2 gap-3'>
                            <div className='relative'>
                                <img
                                    ...
                                    alt="Profile"
                                    className='w-32 h-32 rounded-full object-cover border-2 border-blue-500 cursor-pointer hover:opacity-80 transition-opacity'
